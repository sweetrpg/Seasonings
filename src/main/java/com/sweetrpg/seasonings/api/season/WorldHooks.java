package com.sweetrpg.seasonings.api.season;
...
public class WorldHooks
{
    ...
    public static boolean canSnowAtInSeason(World world, BlockPos pos, boolean checkLight, ISeasonState seasonState)
    {
        try
        {
            return (Boolean)Class.forName("com.sweetrpg.seasonings.season.SeasonASMHelper").getMethod("canSnowAtInSeason", World.class, BlockPos.class, Boolean.class, Season.class).invoke(null, world, pos, checkLight, seasonState);
        }
        catch (Exception e)
        {
    ...
    public static boolean canBlockFreezeInSeason(World world, BlockPos pos, boolean noWaterAdj, ISeasonState seasonState)
    {
        try
        {
            return (Boolean)Class.forName("com.sweetrpg.seasonings.season.SeasonASMHelper").getMethod("canBlockFreezeInSeason", World.class, BlockPos.class, Boolean.class, Season.class).invoke(null, world, pos, noWaterAdj, seasonState);
        }
        catch (Exception e)
        {
    ...
    public static boolean isRainingAtInSeason(World world, BlockPos pos, ISeasonState seasonState)
    {
        try
        {
            return (Boolean)Class.forName("com.sweetrpg.seasonings.season.SeasonASMHelper").getMethod("isRainingAtInSeason", World.class, BlockPos.class, Season.class).invoke(null, world, pos, seasonState);
        }
        catch (Exception e)
        {
