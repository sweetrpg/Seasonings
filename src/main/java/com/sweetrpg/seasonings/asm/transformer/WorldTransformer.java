 ...
 ******************************************************************************/
package com.sweetrpg.seasonings.asm.transformer;
...
import com.sweetrpg.seasonings.asm.ASMHelper;
import com.sweetrpg.seasonings.asm.ObfHelper;
    ...
    private byte[] transformWorld(byte[] bytes, boolean obfuscatedClass)
    {
        ...
        for (MethodNode methodNode : classNode.methods)
        {
            ...
            { 
                ...
                insnList.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com.sweetrpg.seasonings/api/season/SeasonHelper", "getSeasonState", ObfHelper.createMethodDescriptor(obfuscatedClass, "com.sweetrpg.seasonings/api/season/ISeasonState", "net/minecraft/world/World"), false));
                ...
                insnList.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com.sweetrpg.seasonings/season/SeasonASMHelper", "canSnowAtInSeason", ObfHelper.createMethodDescriptor(obfuscatedClass, "Z", "net/minecraft/world/World", "net/minecraft/util/math/BlockPos", "Z", "com.sweetrpg.seasonings/api/season/ISeasonState"), false));
            ...
            { 
                ...
                insnList.add(new VarInsnNode(Opcodes.ILOAD, 2));
                insnList.add(new VarInsnNode(Opcodes.ALOAD, 3));
                insnList.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com.sweetrpg.seasonings/season/SeasonASMHelper", "canBlockFreezeInSeason", ObfHelper.createMethodDescriptor(obfuscatedClass, "Z", "net/minecraft/world/World", "net/minecraft/util/math/BlockPos", "Z", "com.sweetrpg.seasonings/api/season/ISeasonState"), false));
                insnList.add(new InsnNode(Opcodes.IRETURN));
            ...
            { 
                ...
                insnList.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com.sweetrpg.seasonings/season/SeasonASMHelper", "isRainingAtInSeason", ObfHelper.createMethodDescriptor(obfuscatedClass, "Z", "net/minecraft/world/World", "net/minecraft/util/math/BlockPos", "com.sweetrpg.seasonings/api/season/ISeasonState"), false));
                insnList.add(new InsnNode(Opcodes.IRETURN));
